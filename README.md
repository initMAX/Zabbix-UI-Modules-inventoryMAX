...
<img src="./.readme/badge/version.svg" alt="version 2.0.5">
...
The field editor marks its mandatory inputs - a field needs a name, a list column needs a label and a column - with Zabbix's own asterisk, and a save that is rejected marks the offending input in red with the reason under it, on every supported Zabbix version.
